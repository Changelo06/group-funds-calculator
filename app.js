...
const receiptInput = byId("receipt-input"), detailReceipt = byId("detail-receipt"); receiptInput.accept = "image/png,image/jpeg,.jpg,.jpeg,.png"; receiptInput.closest(".receipt-field").querySelector("div > span").innerHTML = "Attach receipt <em>optional</em>"; receiptInput.closest(".receipt-field").querySelector("div > small").textContent = "JPG, JPEG, or PNG · up to 5 MB."; detailReceipt.querySelector("img")?.remove();
