...
const receiptInput = byId("receipt-input"); receiptInput.accept = "image/png,image/jpeg,.jpg,.jpeg,.png"; receiptInput.closest(".receipt-field").querySelector("div > span").innerHTML = "Attach receipt <em>optional</em>"; receiptInput.closest(".receipt-field").querySelector("div > small").textContent = "JPG, JPEG, or PNG · up to 5 MB."; byId("detail-receipt").querySelector("span").innerHTML = "Attached receipt <b>↗</b>";
