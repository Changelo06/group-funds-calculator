...
function renderMembers() {
  ...
  byId("members-list").innerHTML = state.members.map((member, index) => {
    const canManage = canManageMember(member), paymentReady = paymentMethods(member).length > 0, unpaidCount = profileNotificationCount(member.id);
